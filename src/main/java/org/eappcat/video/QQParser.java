...
public class QQParser {
    ...
    private String parseVipUrl(String url,Model model) throws Exception{
        WebRequest webRequest = new WebRequest(new URL("http://api.baiyug.cn/vip_vip2/vip_vip2.php?url=" + url));
    ...
    private String parseURL(String url,Model model) throws Exception{
        Connection test= Jsoup.connect("http://api.baiyug.cn/vip_vip2/vip_vip2.php?url="+url);
